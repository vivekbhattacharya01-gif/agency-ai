...
// const Navbar = ({theme}) => {
  const [sidebarOpen, setSidebarOpen] = React.useState(false);
    ...
    px-6 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20
    backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        <img
         ...
         max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
            ...
            <a onClick={()=> setSidebarOpen(false)} href="#clients" className='sm:hover:border-b'>Clients</a>  
         ...
         <div className='flex items-center gap-2 sm:gap-4 '>
             ...
             <img src={theme === 'dark' ? assets.menu_dark : assets.menu_icon} alt="" 
             className='w-6 sm:hidden cursor-pointer' onClick={()=> setSidebarOpen(true)} />
